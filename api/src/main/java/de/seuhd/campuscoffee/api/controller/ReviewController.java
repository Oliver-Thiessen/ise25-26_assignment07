...
public class ReviewController extends CrudController<Review, ReviewDto, Long> {
    ...
    // TODO: x Implement the missing methods/endpoints.
...
/*
   ...
   probleme mit dem implementieren bzgl. des approved-status
    ...
    public ResponseEntity<List<ReviewDto>> filter(
        ...
        return ResponseEntity.ok(
            ...
            //reviewDtoMapper.fromDomain(reviewService.getByStatus(approved))
        );
    }
